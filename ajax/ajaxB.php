...
<tr class="calculate-subtotal">
    <td><?= $items["id_barang"]; ?></td>
    <td><?= $items["nama_barang"]; ?></td>
    <td><?= $items["harga_barang"]; ?></td>
    <td class="t">
        <input type="number" name="qty[]" class="form-control qty" value="0" min="1">
        ...
        <p class="err-qty text-danger mb-3">Input tidak boleh kurang dari nol</p>
    </td>
